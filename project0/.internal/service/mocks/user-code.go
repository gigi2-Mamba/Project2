...
// SendFaker mocks base method.
func (m *MockCodeService) SendFaker(ctx context.Context, biz, phone string) (error, string) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendFaker", ctx, biz, phone)
	ret0, _ := ret[0].(error)
	ret1, _ := ret[1].(string)
	return ret0, ret1
}

// SendFaker indicates an expected call of SendFaker.
func (mr *MockCodeServiceMockRecorder) SendFaker(ctx, biz, phone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendFaker", reflect.TypeOf((*MockCodeService)(nil).SendFaker), ctx, biz, phone)
}
