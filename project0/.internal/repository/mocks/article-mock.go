...
func (m *MockArticleRepository) Save(ctx context.Context, art domain.Article) (int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockArticleRepositoryMockRecorder) Save(ctx, art any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockArticleRepository)(nil).Save), ctx, art)
}
...
func (m *MockArticleRepository) SyncStatus(ctx context.Context, id, uid int64, status domain.ArticleStatus) error {
	m.ctrl.T.Helper()
