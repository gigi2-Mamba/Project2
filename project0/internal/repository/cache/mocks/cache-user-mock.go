...
//
//	mockgen -source=./repository/cache/user.go -package=cachemocks -destination=./repository/cache/mocks/cache-user-mock.go
//
...
func (m *MockUserCache) Get(ctx context.Context, id int64) (domain.UserProfile, error) {
	m.ctrl.T.Helper()
